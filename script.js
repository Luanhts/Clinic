...
function menu() {
    ...
    console.log("Digite [2] to remove uma Consulta: ")
        ...
        switch (option) {
            case "1":
                readline.question("Enter your name: ", name =>{
                    readline.question("Enter the Doctor name: ", autor => {
                        readline.question("Enter the date : ", pags => {
                ...
                break;
            case "2":
                readline.question("Escreva a consulta a ser removida: ", name => {
                    removeConsult(name);
                    menu()
                });
                break;
